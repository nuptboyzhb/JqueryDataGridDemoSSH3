...
<%@ page import="edu.njupt.zhb.tools.GetParamFromURL"%>
<%
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" >
    	<tr>
    		<th>学号</th>
    		<td>
    			<input id="id" name="student.id" value="<%=GetParamFromURL.getParam(request,"id")%>" style="width: 150px" panelHeight="auto" editable="false" />
    		</td>
    		<th>姓名</th>
    		<td>
    			<input id="name" class="noneinput" name="student.name" value="<%=GetParamFromURL.getParam(request,"name")%>" />
    		</td>
    	</tr>
    	<tr>
    		<th>课程</th>
    		<td>
    			<input id="course" name="student.course" value="<%=GetParamFromURL.getParam(request,"course")%>" style="width: 150px" panelHeight="auto" editable="false"/>
    		</td>
    		<th>分数</th>
    		<td>
    			<input id="score" class="noneinput" name="student.score" value="<%=GetParamFromURL.getParam(request,"score")%>"/>
    		</td>
    	</tr>
    	<tr>
    		<th>备注</th>
